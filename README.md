...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_affinity_transformer"></a> [affinity\_transformer](#module\_affinity\_transformer) | git::https://github.com/MaciekLeks/case-style-transformer.git | 0.1.2 |
| <a name="module_hpa"></a> [hpa](#module\_hpa) | git::https://github.com/MaciekLeks/case-style-transformer.git | 0.1.2 |
| <a name="module_topology_spread_constraints"></a> [topology\_spread\_constraints](#module\_topology\_spread\_constraints) | git::https://github.com/MaciekLeks/case-style-transformer.git | 0.1.2 |
...
| <a name="input_topology_spread_constraints"></a> [topology\_spread\_constraints](#input\_topology\_spread\_constraints) | The default value is 30. If set to 0 or lower, the default value is used. | <pre>list(object({<br>    max_skew : number<br>    topology_key : string<br>    when_unsatisfiable : string<br>    label_selector : object({<br>      match_labels : optional(map(string), {})<br>      match_expressions : optional(list(object({<br>        key : string<br>        operator : string<br>        values : list(string)<br>      })), [])<br>    })<br>  }))</pre> | `[]` | no |
