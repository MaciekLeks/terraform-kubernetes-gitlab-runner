...
| <a name="input_envs"></a> [envs](#input\_envs) | Environment variable to be set for either runner or job or both. | <pre>list(object({<br>    name   = string<br>    value  = string<br>    job    = optional(bool)<br>    runner = optional(bool)<br>  }))</pre> | `null` | no |
...
| <a name="input_job_build_container_resources"></a> [job\_build\_container\_resources](#input\_job\_build\_container\_resources) | The CPU and memory resources given to build containerr. | <pre>object({<br>    requests = object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>    }),<br>    limits = optional(object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>    }))<br>  })</pre> | `null` | no |
| <a name="input_job_helper_container_resources"></a> [job\_helper\_container\_resources](#input\_job\_helper\_container\_resources) | The CPU and memory resources given to helper containers. | <pre>object({<br>    requests = object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>    }),<br>    limits = optional(object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>    }))<br>  })</pre> | `null` | no |
| <a name="input_job_service_account"></a> [job\_service\_account](#input\_job\_service\_account) | Default service account job pods use to talk to Kubernetes API. | <pre>object({<br>    name              = string<br>    overwrite_allowed = optional(bool)<br>  })</pre> | n/a | yes |
| <a name="input_job_service_container_resources"></a> [job\_service\_container\_resources](#input\_job\_service\_container\_resources) | The CPU and memory resources given to service containers. | <pre>object({<br>    requests = object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>    }),<br>    limits = optional(object({<br>      cpu                          = optional(string)<br>      memory                       = optional(string)<br>      cpu_overwrite_max_allowed    = optional(string)<br>      memory_overwrite_max_allowed = optional(string)<br>    }))<br>  })</pre> | `null` | no |
